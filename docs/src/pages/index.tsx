    ...
    <section className={styles.hero}>
      <div className={styles.container}>
        ...
        <div className={styles.actions}>
          ...
          <Link className={styles.secondaryBtn} to="https://github.com/valerachuk/mcpkit">
          ...
          <div className={styles.step}>
            ...
            <div className={styles.stepContent}>
              ...
              <div className={styles.stepCode}>
                <code>npx @mcpkit-dev/cli create my-server</code>
                <button className={styles.copyBtn} onClick={() => navigator.clipboard.writeText('npx @mcpkit-dev/cli create my-server')}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
